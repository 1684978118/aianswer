package com.xiaobo.aianswer.service.impl;
...
import com.xiaobo.aianswer.constant.CommonConstant;
import com.xiaobo.aianswer.exception.ThrowUtils;
import com.xiaobo.aianswer.mapper.AppMapper;
import com.xiaobo.aianswer.model.dto.app.AppQueryRequest;
import com.xiaobo.aianswer.model.entity.App;
import com.xiaobo.aianswer.model.entity.User;
import com.xiaobo.aianswer.model.enums.AppScoringStrategyEnum;
import com.xiaobo.aianswer.model.enums.AppTypeEnum;
import com.xiaobo.aianswer.model.enums.ReviewStatusEnum;
import com.xiaobo.aianswer.model.vo.AppVO;
...
import com.xiaobo.aianswer.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (StringUtils.isNotBlank(appName)) {
            ThrowUtils.throwIf(appName.length() > 80, ErrorCode.PARAMS_ERROR, "应用名称过长,不能大于80");
        }
