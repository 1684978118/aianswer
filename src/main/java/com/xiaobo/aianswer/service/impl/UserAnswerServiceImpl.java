...
public class UserAnswerServiceImpl extends ServiceImpl<UserAnswerMapper, UserAnswer> implements UserAnswerService {
    ...
    public QueryWrapper<UserAnswer> getQueryWrapper(UserAnswerQueryRequest userAnswerQueryRequest) {
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(userId), "appType", appType);
        queryWrapper.eq(ObjectUtils.isNotEmpty(userId), "resultScore", resultScore);
        queryWrapper.eq(ObjectUtils.isNotEmpty(userId), "scoringStrategy", scoringStrategy);
        // 排序规则
