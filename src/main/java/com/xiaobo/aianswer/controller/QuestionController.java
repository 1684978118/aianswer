...
import com.xiaobo.aianswer.annotation.AuthCheck;
import com.xiaobo.aianswer.common.BaseResponse;
import com.xiaobo.aianswer.common.DeleteRequest;
import com.xiaobo.aianswer.common.ErrorCode;
import com.xiaobo.aianswer.common.ResultUtils;
import com.xiaobo.aianswer.config.VipSchedulerConfig;
import com.xiaobo.aianswer.constant.UserConstant;
...
import com.xiaobo.aianswer.model.dto.question.*;
...
import com.xiaobo.aianswer.model.enums.AppTypeEnum;
import com.xiaobo.aianswer.model.vo.QuestionVO;
import com.xiaobo.aianswer.service.AppService;
import com.xiaobo.aianswer.service.QuestionService;
import com.xiaobo.aianswer.service.UserService;
...
public class QuestionController {
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerate(@RequestBody AiGenerateQuestionAddRequest aiGenerateQuestionAddRequest){
        ThrowUtils.throwIf(aiGenerateQuestionAddRequest == null,ErrorCode.PARAMS_ERROR);
        // 获取参数
        Long appId = aiGenerateQuestionAddRequest.getAppId();
        int questionNumber = aiGenerateQuestionAddRequest.getQuestionNumber();
        int optionNumber = aiGenerateQuestionAddRequest.getOptionNumber();
        // 获取应用信息
    ...
    public SseEmitter aiGenerateSSE(AiGenerateQuestionAddRequest aiGenerateQuestionAddRequest,HttpServletRequest request){
        ThrowUtils.throwIf(aiGenerateQuestionAddRequest == null,ErrorCode.PARAMS_ERROR);
        // 获取参数
        Long appId = aiGenerateQuestionAddRequest.getAppId();
        int questionNumber = aiGenerateQuestionAddRequest.getQuestionNumber();
    ...
    public SseEmitter aiGenerateQuestionSSETest(AiGenerateQuestionAddRequest aiGenerateQuestionRequest,
                                                boolean isVip) {
